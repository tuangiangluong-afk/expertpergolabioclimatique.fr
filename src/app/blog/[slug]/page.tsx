...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return {
        title: clampTitle(post.seo_title || `${post.title} | Expert Pergola Bioclimatique`),
...
export default async function BlogPost({ params }: { params: Promise<{ slug: string }> }) {
    ...
    const schema = {
        ...
        "author": {
            "@type": "Person",
            "name": post.author_name || "Expert Pergola Bioclimatique",
            "url": post.author_slug ? `https://www.expertpergolabioclimatique.fr/author/${post.author_slug}` : undefined,
            "@id": post.author_slug ? `https://www.expertpergolabioclimatique.fr/author/${post.author_slug}#person` : undefined
        },
        "publisher": {
        ...
        "mainEntityOfPage": {
            ...
            "@id": `https://www.expertpergolabioclimatique.fr/blog/${slug}`
    ...
    const howToSchema = (headers && headers.length >= 3) ? {
        ...
        "step": headers.map((h: any, i: number) => ({
            ...
            "name": h.text,
            "text": h.text,
            "url": `https://www.expertpergolabioclimatique.fr/blog/${slug}#${h.id}`
        }))
    } : null;
                    ...
                    <aside className="lg:col-span-4 space-y-8">
                        ...
                        <div className="bg-white border border-neutral-200 rounded-2xl p-6 shadow-sm">
                         ...
                         <div className="bg-gradient-to-br from-stone-950 to-stone-900 text-white rounded-2xl p-8 text-center shadow-lg">
                            ...
                            <Link href="/#simulateur" className="inline-block bg-white text-stone-900 px-6 py-3 rounded-full font-bold hover:bg-stone-50 transition-colors w-full">
                                Commencer
                            </Link>
                         </div>
                    </aside>
